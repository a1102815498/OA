...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${path}/assets/skin/default_skin/css/theme.css">
    <link rel="stylesheet" type="text/css" href="${path}/assets/admin-tools/admin-forms/css/admin-forms.css">
