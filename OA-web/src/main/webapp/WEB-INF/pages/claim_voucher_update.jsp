        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <form:form id="admin-form" name="addForm" action="/claim_voucher/update" modelAttribute="info">
                    <form:hidden path="claim_voucher.id"/>
                    <div class="panel-body bg-light">
                        <div class="section-divider mt20 mb40">
                            <span> 基本信息 </span>
                        </div>
                        <div class="section">
                            <label for="claim_voucher.cause" class="field prepend-icon">
                                <form:input path="claim_voucher.cause" cssClass="gui-input" placeholder="事由..."/>
                                <label for="claim_voucher.cause" class="field-icon">
                            ...
                            <div>
                                <div class="col-md-3">
                                    <label for="items[${sta.index}].item" class="field prepend-icon">
                                        ...
                                        <form:hidden path="items[${sta.index}].claim_voucher_id"/>
                        ...
                        <div class="section row">
                            <div class="col-md-3">
                                <label for="totalMoney" class="field prepend-icon">
                                    <form:input id="totalMoney" path="claim_voucher.total_amount" cssClass="gui-input" placeholder="总金额..." readonly="true"/>
