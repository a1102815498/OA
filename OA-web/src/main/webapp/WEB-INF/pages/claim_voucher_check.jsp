...
<%@ page import="com.cyl.global.Contant" %>
            ...
            <div class="panel heading-border">
                <div class="panel-body bg-light">
                    ...
                    <div class="section row">
                        ...
                        <div class="col-md-4"><spring:eval expression="claimVoucher.create_time"/></div>
                    </div>
                    <div class="section row">
                    ...
                    <div class="section row">
                        ...
                        <div class="col-md-6">${claimVoucher.total_amount}</div>
                    </div>
                    <div class="section-divider mt20 mb40">
                        <span> 处理流程 </span>
                    </div>
                    ...
                    <c:forEach items="${records}" var="record">
                        ...
                        <div class="col-md-3"><spring:eval expression="record.deal_time"/></div>
                        <div class="col-md-1">${record.deal_way}</div>
                        <div class="col-md-2">${record.deal_way}</div>
                    ...
                    <form:form id="admin-form" name="addForm" action="/claim_voucher/check" modelAttribute="record">
                        <form:hidden path="claim_voucher_id" />
                        <div class="panel-body bg-light">
                            <div class="section">
                            ...
                            <div class="panel-footer text-right">
                                ...
                                <button type="submit" class="button" name="deal_way" value="${Contant.DEAL_PASS}" >${Contant.DEAL_PASS}</button>
                                <button type="submit" class="button" name="deal_way" value="${Contant.DEAL_BACK}" >${Contant.DEAL_BACK}</button>
                                <button type="submit" class="button" name="deal_way" value="${Contant.DEAL_REJECT}" >${Contant.DEAL_REJECT}</button>
                                </c:if>
                                <c:if test="${sessionScope.employee.post==Contant.POST_CASHIER}">
                                <button type="submit" class="button" name="deal_way" value="${Contant.DEAL_PAID}" >${Contant.DEAL_PAID}</button>
                                </c:if>
